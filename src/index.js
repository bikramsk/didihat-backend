    ...
    strapi.server.routes([
      {
        ...
        handler: async (ctx) => {
          try {
            ...
            // Generate sequential booking ID by querying the DB
            let sequentialBookingId = 1;
            try {
              ...
              if (lastBooking && lastBooking.bookingId) {
                ...
                sequentialBookingId = isNaN(lastId) ? 1 : lastId + 1;
              }
            } catch (err) {
              strapi.log.warn('Could not fetch last booking for sequential ID, defaulting to 1');
            }
